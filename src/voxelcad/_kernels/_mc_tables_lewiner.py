...
# ---------------------------------------------------------------------------
# Numpy decoder — converts base64 tuples to numpy arrays at import time
# ---------------------------------------------------------------------------
import base64 as _b64
import numpy as _np


def _decode(raw_tuple):
    """Decode a (shape, base64_str) tuple into a numpy int8 array."""
    shape = raw_tuple[0]
    data = _b64.b64decode(raw_tuple[1].replace('\n', ''))
    return _np.frombuffer(data, dtype=_np.int8).reshape(shape).copy()


# Decoded numpy arrays — use these in Cython kernels via typed memoryviews
cases = _decode(CASES)
casesClassic = _decode(CASESCLASSIC)
tiling1 = _decode(TILING1)
tiling2 = _decode(TILING2)
tiling3_1 = _decode(TILING3_1)
tiling3_2 = _decode(TILING3_2)
tiling4_1 = _decode(TILING4_1)
tiling4_2 = _decode(TILING4_2)
tiling5 = _decode(TILING5)
tiling6_1_1 = _decode(TILING6_1_1)
tiling6_1_2 = _decode(TILING6_1_2)
tiling6_2 = _decode(TILING6_2)
tiling7_1 = _decode(TILING7_1)
tiling7_2 = _decode(TILING7_2)
tiling7_3 = _decode(TILING7_3)
tiling7_4_1 = _decode(TILING7_4_1)
tiling7_4_2 = _decode(TILING7_4_2)
tiling8 = _decode(TILING8)
tiling9 = _decode(TILING9)
tiling10_1_1 = _decode(TILING10_1_1)
tiling10_1_1_ = _decode(TILING10_1_1_)
tiling10_1_2 = _decode(TILING10_1_2)
tiling10_2 = _decode(TILING10_2)
tiling10_2_ = _decode(TILING10_2_)
tiling11 = _decode(TILING11)
tiling12_1_1 = _decode(TILING12_1_1)
tiling12_1_1_ = _decode(TILING12_1_1_)
tiling12_1_2 = _decode(TILING12_1_2)
tiling12_2 = _decode(TILING12_2)
tiling12_2_ = _decode(TILING12_2_)
tiling13_1 = _decode(TILING13_1)
tiling13_1_ = _decode(TILING13_1_)
tiling13_2 = _decode(TILING13_2)
tiling13_2_ = _decode(TILING13_2_)
tiling13_3 = _decode(TILING13_3)
tiling13_3_ = _decode(TILING13_3_)
tiling13_4 = _decode(TILING13_4)
tiling13_5_1 = _decode(TILING13_5_1)
tiling13_5_2 = _decode(TILING13_5_2)
tiling14 = _decode(TILING14)
test3 = _decode(TEST3)
test4 = _decode(TEST4)
test6 = _decode(TEST6)
test7 = _decode(TEST7)
test10 = _decode(TEST10)
